...
public abstract class AbstractRNG implements IRNG {
    ...
    public double nextDoubleInclusive(final double outer) {
        return nextDouble() * 1.0000000000000002 * outer;
    }
    ...
    public float nextFloatInclusive(final float outer) {
        return nextFloat() * 1.0000001f * outer;
    }
    ...
    /**
     * Returns a random element from the provided list. If the list is null or empty
     ...
     * <br>
     * You should generally prefer {@link #getRandomElement(List)} whenever you have a choice of types.
     *
