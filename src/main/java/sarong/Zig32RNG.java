...
import sarong.discouraged.Light32RNG;
 ...
 * 32-bit SplitMix algorithm {@link Light32RNG} uses with a 32-bit Marsaglia XorShift generator, adding the XorShift's
...
public final class Zig32RNG implements StatefulRandomness, Serializable {
    ...
    public final long nextLong() {
        int z = (b + 0x632BE5AB), y = (b += 0xC657CB56);
        a ^= a >>> 14;
        z = (z ^ z >>> 15) * 0xAD7B5;
        a ^= a << 1;
        z = (z ^ z >>> 12) * 0xCDD1D + (a ^= a >>> 15);
