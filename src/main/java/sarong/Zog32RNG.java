...
public final class Zog32RNG implements StatefulRandomness, Serializable {
    ...
    public final long nextLong() {
        int z = (b + 0xC74EAD55), y = (b += 0x8E9D5AAA);
        a ^= a >>> 14;
        z = (z ^ z >>> 10) * 0xA5CB3;
        a ^= a >>> 15;
        z = (z ^ z >>> 20) + (a ^= a << 13);
        ...
        y = (y ^ y >>> 10) * 0xA5CB3;
        a ^= a >>> 15;
        return (long)((y ^ y >>> 20) + (a ^= a << 13)) << 32 ^ z;
    }
     ...
     * Call with {@code determine(a = (a = (a ^= a >>> 14) ^ a >>> 15) ^ a << 13, b += 0xC74EAD55)},
    ...
    {
        return ((b = (b ^ b >>> 10) * 0xA5CB3) ^ b >>> 20) + a;
    }
    /**
     ...
     * {@code determineBounded(a = (a = (a ^= a >>> 14) ^ a >>> 15) ^ a << 13, b += 0xC74EAD55), bound},
    ...
    {
        return ((bound * (((b = (b ^ b >>> 10) * 0xA5CB3) ^ b >>> 20) + a & 0x7FFF)) >> 15);
    }
    /**
