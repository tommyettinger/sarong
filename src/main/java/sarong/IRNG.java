...
public interface IRNG extends RandomnessSource {
     ...
     * or negative. Because of how math on doubles works, there are at most 2 to the 62 values this can return for any
     ...
     */
    double nextDoubleInclusive(final double outer);
    /**
     ...
     */
    float nextFloatInclusive(final float outer);
